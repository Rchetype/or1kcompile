...
#define TARGET_MASK_CMOV_P(target_flags) ((target_flags & MASK_MASK_CMOV) != 0)
...
#define TARGET_MASK_ROR_P(target_flags) ((target_flags & MASK_MASK_ROR) != 0)
#define TARGET_MASK_SEXT ((target_flags & MASK_MASK_SEXT) != 0)
#define TARGET_MASK_SEXT_P(target_flags) ((target_flags & MASK_MASK_SEXT) != 0)
...
enum opt_code
{
  ...
  OPT_fipa_sem_equality = 741,               /* -fipa-sem-equality */
  ...
  OPT_mboard_ = 1137,                        /* -mboard= */
  OPT_mcmov = 1138,                          /* -mcmov */
  OPT_mcompat_delay = 1139,                  /* -mcompat-delay */
  OPT_mdelay = 1140,                         /* -mdelay */
  OPT_mdouble_float = 1141,                  /* -mdouble-float */
  OPT_mhard_div = 1142,                      /* -mhard-div */
  OPT_mhard_float = 1143,                    /* -mhard-float */
  OPT_mhard_mul = 1144,                      /* -mhard-mul */
  OPT_mnewlib = 1145,                        /* -mnewlib */
  OPT_mno_delay = 1146,                      /* -mno-delay */
  OPT_mpadstruct = 1147,                     /* -mpadstruct */
  OPT_mredzone_ = 1148,                      /* -mredzone= */
  OPT_mror = 1149,                           /* -mror */
  OPT_msext = 1150,                          /* -msext */
  OPT_msoft_div = 1151,                      /* -msoft-div */
  OPT_msoft_float = 1152,                    /* -msoft-float */
  OPT_msoft_mul = 1153,                      /* -msoft-mul */
  OPT_n = 1154,                              /* -n */
  OPT_no_canonical_prefixes = 1155,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1156,              /* -no-integrated-cpp */
  OPT_nocpp = 1157,                          /* -nocpp */
  OPT_nodefaultlibs = 1158,                  /* -nodefaultlibs */
  ...
  OPT_pie = 1169,                            /* -pie */
  OPT_pipe = 1170,                           /* -pipe */
  OPT_print_file_name_ = 1171,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1172,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1173,          /* -print-multi-directory */
  OPT_print_multi_lib = 1174,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1175,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1176,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1177,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1178,               /* -print-prog-name= */
  OPT_print_search_dirs = 1179,              /* -print-search-dirs */
  OPT_print_sysroot = 1180,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1181,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1182,                          /* -quiet */
  OPT_r = 1183,                              /* -r */
  OPT_remap = 1184,                          /* -remap */
  OPT_s = 1185,                              /* -s */
  OPT_s_bc_abi = 1186,                       /* -s-bc-abi */
  OPT_save_temps = 1187,                     /* -save-temps */
  OPT_save_temps_ = 1188,                    /* -save-temps= */
  OPT_shared = 1189,                         /* -shared */
  OPT_shared_libgcc = 1190,                  /* -shared-libgcc */
  /* OPT_specs = 1191, */                    /* -specs */
  OPT_specs_ = 1192,                         /* -specs= */
  OPT_static = 1193,                         /* -static */
  OPT_static_libasan = 1194,                 /* -static-libasan */
  OPT_static_libgcc = 1195,                  /* -static-libgcc */
  OPT_static_libgcj = 1196,                  /* -static-libgcj */
  OPT_static_libgfortran = 1197,             /* -static-libgfortran */
  OPT_static_libgo = 1198,                   /* -static-libgo */
  OPT_static_liblsan = 1199,                 /* -static-liblsan */
  OPT_static_libmpx = 1200,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1201,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1202,               /* -static-libstdc++ */
  OPT_static_libtsan = 1203,                 /* -static-libtsan */
  OPT_static_libubsan = 1204,                /* -static-libubsan */
  /* OPT_std_c__03 = 1205, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1206, */                /* -std=c++0x */
  OPT_std_c__11 = 1207,                      /* -std=c++11 */
  OPT_std_c__14 = 1208,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1209, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1210, */                /* -std=c++1y */
  OPT_std_c__1z = 1211,                      /* -std=c++1z */
  ...
  OPT_std_gnu__14 = 1227,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1228, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1229, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1230,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1231,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1232,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1233, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1234, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1235,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1236,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1237, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1238, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1239,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1240, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1241, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1242, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1243,                     /* -std=legacy */
  OPT_symbolic = 1244,                       /* -symbolic */
  OPT_t = 1245,                              /* -t */
  OPT_time = 1246,                           /* -time */
  OPT_time_ = 1247,                          /* -time= */
  OPT_traditional = 1248,                    /* -traditional */
  OPT_traditional_cpp = 1249,                /* -traditional-cpp */
  OPT_trigraphs = 1250,                      /* -trigraphs */
  OPT_u = 1251,                              /* -u */
  OPT_undef = 1252,                          /* -undef */
  OPT_v = 1253,                              /* -v */
  OPT_version = 1254,                        /* -version */
  OPT_w = 1255,                              /* -w */
  OPT_wrapper = 1256,                        /* -wrapper */
  OPT_x = 1257,                              /* -x */
  OPT_z = 1258,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
